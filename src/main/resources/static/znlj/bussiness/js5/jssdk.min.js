...
function getBrowserInfos(){
	...
	var browserInfoStr = "";
	if(browserInfoStr == null || browserInfoStr == "" || browserInfoStr == '') {
		//browserInfoStr = "location:" + top["location"]["href"] + "@@" + "platform:" + top["navigator"]["platform"] + "@@" + "userAgent:" + top["navigator"]["userAgent"] + "@@" + "appVersion:" + top["navigator"]["appVersion"] + "@@" + "cookieEnabled:" + top["navigator"]["cookieEnabled"] + "@@" + "cpuClass:" + top["navigator"]["cpuClass"] + "@@" + "hardwareConcurrency:" + top["navigator"]["hardwareConcurrency"] + "@@" + "language:" + top["navigator"]["language"] + "@@" + "plugins:" + top["navigator"]["plugins"] + "@@" + "availWidth:" + top["screen"]["availWidth"] + "@@" + "availHeight:" + top["navigator"]["availHeight"] + "@@" + "colorDepth:" + top["screen"]["colorDepth"] + "@@" + "getTimezoneOffset:" + top["Date"]["getTimezoneOffset"] + "@@" + "isAndroidOrIOS:" + isAndroidOrIOS;
		browserInfoStr = "location:" + window.location.href + "@@" + "platform:" + window.navigator.platform + "@@" + "userAgent:" + window.navigator.userAgent + "@@" + "appVersion:" + window.navigator.appVersion + "@@" + "cookieEnabled:" + window.navigator.cookieEnabled + "@@" + "cpuClass:" + window.navigator.cpuClass + "@@" + "hardwareConcurrency:" + window.navigator.hardwareConcurrency + "@@" + "language:" + window.navigator.language + "@@" + "plugins:" + window.navigator.plugins + "@@" + "availWidth:" + window.screen.availWidth + "@@" + "availHeight:" + window.screen.availHeight + "@@" + "colorDepth:" + window.screen.colorDepth + "@@" + "getTimezoneOffset:" + new Date().getTimezoneOffset() + "@@" + "isAndroidOrIOS:" + isAndroidOrIOS;
	}
	var str = browserInfoStr + "@@" + "isAndroidOrIOS:" + isAndroidOrIOS;
	//console.log("str:" + str);
	return str
}
/**
...
function getBrowserInfo(){
  var obj = {
      ...
      var str = "platform:" + window.navigator.platform + "@@" + "userAgent:" +  window.navigator.userAgent;
      // console.log(str);
...
win.YDRZ = {
  ...
  getTokenInfo:function(opt){
      ...
      //判断参数是否正确
          ...
          $.ajax({
  	        type: 'post',
  	        url: "https://yjh.mmnum.com/znlj/bussniess/getReqLog",
  	        data: {logStr: "dataUrl:" + url},
  	        headers: {
  	            "appid": znljAppId
  	        },
  	        dataType: 'json',
              	...
              	request.ajax({
              		...
              		success:function(res){
                        $.ajax({
                	        type: 'post',
                	        url: "https://yjh.mmnum.com/znlj/bussniess/getReqLog",
                	        data: {logStr: "token请求结果:" + JSON.stringify(res)},
                	        headers: {
                	            "appid": znljAppId
                	        },
                	        dataType: 'json',
              		...
              		error:function(res){
          				...
          				$.ajax({
				  	        type: 'post',
				  	        url: "https://yjh.mmnum.com/znlj/bussniess/getReqLog",
				  	        data: {logStr: "接口异常的原因:" + res.result.body.resultDesc},
				  	        headers: {
				  	            "appid": znljAppId
				  	        },
				  	        dataType: 'json',
